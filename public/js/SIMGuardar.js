...
function Validar_SIM_Guardar(){
	if ($('select[name=empresa]').val() == 0 || $('select[name=granja]').val() == 0 || $('input[name=zona]').val() == "" || $('select[name=edad]').val() == 0 || $('select[name=sexo]').val() == "" || $('input[name=nro_pollos]').val() == "" || $('input[name=fecha]').val() == "") {
