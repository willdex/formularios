...
<div class="row">	
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h4 style="color: red"><b>SISTEMA INTEGRAL DE MONITOREO POR PAIS</b></h4>                    
    </div>    
    
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            <font size="2"><b>PAIS: </b></font><br>
    		    <select name="id_pais" class="form-control selectpicker" id="id_pais" data-live-search="true" >
    		        @foreach($buscar_pais as $pa)
    		        <option value="{{$pa->id}}">{{$pa->nombre}}</option>
    		        @endforeach
    		    </select>
    		</div>

        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" id="div_ciudad">
            <font size="2"><b>CIUDAD: </b></font><br>
            <select name="id_ciudad" class="form-control selectpicker" id="id_ciudad" data-live-search="true">
                <option value="0">Todos Las Ciudades</option>
                @foreach($buscar_ciudad as $ciu)
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12" align="left"><br>
            <button class="btn-sm btn-info" title="BUSCAR" onclick="Sistema_Integral_Monitoreo_Pais()"><i class="fa fa-search"></i></button> 
            <button class="btn-sm btn-success" title="EXCEL" id="btn_excel" onclick="Sistema_Integral_Monitoreo_Pais_Excel()"><i class="fa fa-file-text" aria-hidden="true"></i></button> 
        </div>                                      
